...
public class NganhTuyenSinhPanel extends JPanel {
    ...
    private static final String[] TABLE_COLUMNS = {"STT", "Mã xét tuyển", "Tên ngành", "Chương trình đào tạo", "Ngưỡng đầu vào", "Chỉ tiêu chốt", "Điểm trúng tuyển", "Phương thức", "Số thí sinh đăng ký", "Thao tác"};
    ...
    private void applyFixedColumnWidths() {
        int[] widths = {70, 150, 300, 180, 120, 120, 140, 160, 140, 96};
    ...
    private void loadPage(int page) {
        try {
            ...
            for (int i = 0; i < rows.size(); i++) {
                ...
                tableModel.addRow(new Object[]{ stt, emptyIfNull(r.getMaXetTuyen()), emptyIfNull(r.getTenNganh()), emptyIfNull(r.getChuongTrinh()), emptyIfNull(r.getNguongDauVao()), r.getChiTieuChot() == null ? "" : r.getChiTieuChot().toString(), emptyIfNull(r.getDiemTrungTuyen()), emptyIfNull(r.getPhuongThuc()), r.getSoThiSinhDangKy() == null ? "" : r.getSoThiSinhDangKy().toString(), "" });
            }
