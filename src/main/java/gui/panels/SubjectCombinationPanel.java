...
public class SubjectCombinationPanel extends JPanel {
    ...
    private String generateCombinationName(String mon1, String mon2, String mon3) {
        List<String> names = new ArrayList<>();
        if (mon1 != null && !mon1.trim().isEmpty()) names.add(mon1.trim());
        if (mon2 != null && !mon2.trim().isEmpty()) names.add(mon2.trim());
        if (mon3 != null && !mon3.trim().isEmpty()) names.add(mon3.trim());
